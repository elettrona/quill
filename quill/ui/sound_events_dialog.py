...
_EARCON_LABELS: dict[str, str] = {
    ...
    "conversation_listen": "Conversation: listening (mic open)",
    "conversation_review": "Conversation: command captured",
    "conversation_ready": "Conversation: action done",
    "conversation_idle": "Conversation: relaxed to idle",
    "conversation_thinking_tick": "Conversation: still working tick",
    "conversation_error": "Conversation: no command matched",
