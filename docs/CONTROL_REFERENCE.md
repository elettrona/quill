<!-- AUTO-GENERATED FILE. Do not hand-edit.
    Generated by quill/tools/build_docs.py on 2026-07-02 08:21 UTC.
...
A plain-language overview of the document conversion services: what the free local converter and the local OCR engine each do, what they cost (nothing), what stays on your machine (everything), and the current install status of the OCR engine.
...
Turn hands-free 'Hey QUILL' voice commands on or off while dictating.
