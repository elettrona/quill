...
- **Hey QUILL Commands is now a checkable on/off toggle.** The **Reading → Dictation → Hey QUILL Commands** menu item used to jump (and fail) into a settings tab. It is now a checkable item that flips the setting directly, persists, reflects the current state, and speaks "Hey QUILL voice commands on/off".
