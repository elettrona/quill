...
_REVIEWED_PERSISTENCE: dict[str, str] = {
    ...
    # --- needs-versioning (real config; the backlog) ---
    "core/assistant_ai.py::save_assistant_connection_settings": "needs-versioning",
    "core/assistant_ai.py::save_provider_model": "needs-versioning",
    "core/ai/external_engine.py::save_engine_config": "needs-versioning",
    "core/ai/model_manager.py::save_model_choice": "needs-versioning",
    "core/ai/model_tiers.py::_write_raw": "needs-versioning",
    "core/publishing.py::save_publishing_connections": "needs-versioning",
    "core/publishing_linkage.py::save_publishing_linkage_registry": "needs-versioning",
    "core/quillin_settings.py::save_settings": "needs-versioning",
    "core/quillins/loader.py::save_state": "needs-versioning",
    "core/remote_sites.py::save_sites": "needs-versioning",
    "core/ssh/sites.py::save_sites": "needs-versioning",
    "core/speech/models.py::save_installed_models": "needs-versioning",
    "core/watch_profile_store.py::_save_locked": "needs-versioning",
    "core/menu_customization.py::save_menu_customization": "needs-versioning",
    "core/profile_startup.py::save_profile_startup_config": "needs-versioning",
    "ui/ai_hub_dialog.py::_save_deepgram_max_speakers": "needs-versioning",
    "ui/main_frame_power_tools.py::toggle_read_only_guard": "needs-versioning",
}
