...
_PACK_LABELS: dict[str, str] = {
    ...
    "tools.misspelling_list_ranked": "Misspelling List (Ranked by Frequency)",
    "file.open_from_favorite_folder": "Open From Favorite Folder",
    ...
    "navigate.previous_fold": "Previous Fold",
    "tools.list_folds": "List Folds",
